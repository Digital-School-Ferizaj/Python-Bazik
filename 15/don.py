...
frame2_left.grid(row=1, column=0)
frame2_right.grid(row=1, column=1)
...
#3d checbox
game_dev_checkbox = Checkbutton(frame3_left, variable="3D Game Dev", bg="#00014e")
...
button2.grid(row=0, column=1, sticky=W, pady=15, padx=15)
