...
#this function will create the small balls
...
#this function will check which ball did player 1 eat (+10 and -10)
def check_catch_p1():
    global running
    if running:
        ...
        for small_ball in small_balls:
            #get the position of small ball
            (small_ball_x, small_ball_y, small_ball_x2, small_ball_y2) = c.coords(small_ball)
            if player1_x < small_ball_x and player1_x2 < small_ball_x2 and abs(player1_y2 - small_ball_y2) < 30:
...
#this function will check which ball did player 2 eat (+10 and -10)
def check_catch_p2():
    global running
    if running:
        #get the position of player 1
        ...
        for small_ball in small_balls:
            #get the position of small ball
            (small_ball_x, small_ball_y, small_ball_x2, small_ball_y2) = c.coords(small_ball)
            if player2_x < small_ball_x and player2_x2 < small_ball_x2 and abs(player2_y2 - small_ball_y2) < 30:
                small_ball_color = c.itemcget(small_ball, "fill")
...
#This function will check if player 1 ate player 2 or vice versa
def check_winner():
    global running
    if running:
        (player2_x, player2_y, player2_x2, player2_y2) = c.coords(player2)
...
#these functions will update score
...
#the functions will move the player
